...
$daftarhari[]= "Ulangan Teori";
$daftarhari[]="Ulangan Praktek";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-calendar"></i> Ujian</li>
          </ol>
        </section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="ujian_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							 ...
							 <div class="form-group">
								<label>Tanggal Ujian</label>
									<div class="input-group date">
										...
										<input id="Tanggal_Lahir" name="tgl_ujian" type="text" class="form-control" placeholder="Tanggal Ujian">
									</div>
							</div>
							<div class="form-group">
		...
		<div id="ModalEditUjian" class="modal fade" tabindex="-1" role="dialog"></div>
