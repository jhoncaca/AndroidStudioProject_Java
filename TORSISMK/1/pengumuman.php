  ...
  <body class="hold-transition skin-red sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
              ...
              <div class="box">
                ...
                <div class="box-body">
                	<?php if ($_SESSION['akses']!='bk') {
							?>
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Tambah Pengumuman</button></a>
				<?php
						}
						?>
                  <br></br>
							...
							<div class="form-group">
								<label>Isi</label>
									<div class="input-group">
										...
										<input name="isi" type="text" class="form-control" placeholder="Isi Pengumuman"/>
									</div>
							</div>
		...
		<div id="ModalEditpengumuman" class="modal fade" tabindex="-1" role="dialog"></div>
