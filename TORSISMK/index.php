...
<html>
  <head>
	...
	<!-- Icon -->
	<link rel="shortcut icon" type="image/icon" href="logoskr.ico">
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="aset/plugins/iCheck/square/red.css">
  </head>
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <b>TORSIS</b>
        <h6>Aplikasi Pemantau Kemajuan Siswa</h6>
        <h4>SMK SANGKURIANG 1 CIMAHI</H4>
      </div><!-- /.login-logo -->
        ...
        <form action="vl_user.php" method="post">
          ...
          <div class="form-group has-feedback">
            <select class="form-control" name="hak_akses">
                      <option value="n">Pilih Hak Akses</option>
